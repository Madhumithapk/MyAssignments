...
public class FaceBook {
	...
	public static void main(String[] args) {
		...
		// Step 1: Download and set the path 
				...
				driver.findElement(By.xpath("//input[contains(@name,'last')]")).sendKeys("PK");
				// Step 9: Enter the mobile number
				driver.findElement(By.xpath("//div[text()='Mobile number or email address']/following-sibling::input")).sendKeys("9789169376");
